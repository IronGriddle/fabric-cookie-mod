...
import net.cookiemod.socket.SocketCookieItem;
...
public class Items {
    ...
    public static final BlockItem PORTAL_ITEM = new BlockItem(PORTAL_BLOCK, new FabricItemSettings()
            .group(COOKIE_GROUP)
    );
    ...
    public static final Item SOCKET_COOKIE = new SocketCookieItem(new FabricItemSettings().group(COOKIE_GROUP));


    public static void init() {
        Registry.register(Registry.ITEM, new Identifier(MODID, "socket_cookie" ), SOCKET_COOKIE);
        ...
        Registry.register(Registry.ITEM, new Identifier(MODID, "portal" ), PORTAL_ITEM);
